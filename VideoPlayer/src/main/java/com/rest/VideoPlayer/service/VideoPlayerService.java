package com.rest.VideoPlayer.service;
...
import static com.rest.VideoPlayer.constants.ApplicationConstants.*;

@Service
public class VideoPlayerService {
    private final Logger logger = LoggerFactory.getLogger(VideoPlayerService.class);
